          ...
          <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            <div class="flex-1 min-w-0">
              ...
              <div class="flex items-center gap-3 mb-2">
                ...
                <span
                  v-if="contact.attachmentCount"
                  class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300 whitespace-nowrap"
                  :title="`${contact.attachmentCount} pièce(s) jointe(s)`"
                >
                  <font-awesome-icon icon="paperclip" />
                  {{ contact.attachmentCount }}
                </span>
              </div>
